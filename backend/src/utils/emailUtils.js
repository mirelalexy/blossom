        ...
        body: JSON.stringify({
            ...
            html: `
                ...
                <head>
                    <meta charset="utf-8" />
                    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                    <title>Verify your Blossom account</title>
                </head>
                <body style="margin:0;padding:0;background:#f8f6f2;font-family:Arial,Helvetica,sans-serif;color:#3b3b3b;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:40px 20px;">
                        <tr>
                                ...
                                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;padding:48px 40px;">
                                    <tr>
                                        <td align="center">
                                            ...
                                            <p style="margin:0 0 28px;font-size:16px;line-height:1.6;color:#555;">
                                                One quick click and your account's fully set up.
                                            </p>
                                            ...
                                            <p style="margin:16px 0 0;font-size:14px;line-height:1.6;color:#777;">
                                                If you didn't create a Blossom account, you can safely ignore this email. Your password won't change.
                                            </p>
...
export async function sendEmailChangedEmail(oldEmail, newEmail) {
    const res = await fetch(RESEND_API_URL, {
        ...
        body: JSON.stringify({
            from: process.env.EMAIL_FROM,
            to: oldEmail,
            subject: "Your Blossom email address was changed",
            html: `
                <!DOCTYPE html>
                <html>
                <head>
                    <meta charset="utf-8" />
                    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                    <title>Your Blossom email address was changed</title>
                </head>
                <body style="margin:0;padding:0;background:#f8f6f2;font-family:Arial,Helvetica,sans-serif;color:#3b3b3b;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:40px 20px;">
                        <tr>
                                ...
                                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;padding:48px 40px;">
                                    <tr>
                                        <td align="center">
                                            ...
                                            <h2 style="margin:0 0 16px;font-size:24px;color:#3b3b3b;">
                                                Your email address was changed from <strong>${to}</strong> to <strong>${newEmail}</strong>.
                                            </h2>
    ...
    if (!res.ok) {
        const errorText = await res.text()
        console.error("Resend API error: ", res.status, errorText)
        throw new Error("Failed to send email address changed email")
    }
}

export async function sendEmailChangeConfirmationEmail(to, confirmLink) {
    const res = await fetch(RESEND_API_URL, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        ...
        body: JSON.stringify({
            from: process.env.EMAIL_FROM,
            to,
            subject: "Confirm your new Blossom email",
            html: `
                <!DOCTYPE html>
                <html>
                <head>
                    <meta charset="utf-8" />
                    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                    <title>Confirm your new Blossom email</title>
                </head>
                <body style="margin:0;padding:0;background:#f8f6f2;font-family:Arial,Helvetica,sans-serif;color:#3b3b3b;">
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:40px 20px;">
                        <tr>
                                ...
                                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;padding:48px 40px;">
                                    <tr>
                                        <td align="center">
                                            ...
                                            <h2 style="margin:0 0 16px;font-size:24px;color:#3b3b3b;">
                                                Confirm this is your new email
                                            </h2>

                                            <p style="margin:0 0 28px;font-size:16px;line-height:1.6;color:#555;">
                                                We received a request to change the email address for your Blossom account.
                                                To complete the change, please verify your new email address by clicking 
                                                the button below.
                                            </p>
                                            ...
                                            <p style="margin:0;font-size:14px;line-height:1.6;color:#777;">
                                                ...
                                                Your Blossom account will continue using your current email address 
                                                unless this new address is verified.
                                            </p>
