...
- Theme, Notifications (conditional frequency control), Monthly Budget, Categories (with custom icons), Currency (currently supporting EUR, RON, USD, GBP, CAD, AUD, and JPY), Custom Spending Rules
